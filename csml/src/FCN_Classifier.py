    ...
    def __init__(self):
        ...
        super(FCN, self).__init__(
            conv1_1=L.Convolution2D(
                None, self.n_layer1, ksize=3, stride=1, pad=1, initialW=initializer),
            conv1_2=L.Convolution2D(
                None, self.n_layer1, ksize=3, stride=1, pad=1, initialW=initializer),
            conv2_1=L.Convolution2D(
                None, self.n_layer2, ksize=3, stride=1, pad=1, initialW=initializer),
            conv2_2=L.Convolution2D(
                None, self.n_layer2, ksize=3, stride=1, pad=1, initialW=initializer),
            convcha3=L.Convolution2D(
                None, 2, ksize=1, stride=1, pad=0, initialW=initializer),
            deconvsize3=L.Deconvolution2D(
                None, 2, ksize=4, stride=2, pad=1, initialW=initializer),
